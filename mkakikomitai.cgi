...
#─＜基本設定開始＞────────────────────────────────────────────────────────
$url                        = "https://lingling.blog/";                    #首頁的網址
$script                     = './mkakikomitai.cgi';                     #主程式檔名
$logfile                    = './mkakikomitai.txt';                     #留言記錄檔名
$lockfile                   = './mkakikomitai.lock';                    #鎖定檔檔名
$cntfile                    = './mkakikomitai.cnt';                     #計數器記錄檔名 (不使用則改為'')
$logfile2                   = './mkakikomitai_cnt.txt';                 #設定記錄留言者留言篇數的晉級狀態記錄檔。(使用晉級制度必須有此檔案,不使用則改為'')
...
$title                      = '我的留言板';                             #留言板的標題
$titlelogo                  = '<img src=./img/BBS.jpg width=440 height=165>';   #留言板標題圖檔IMG語法 (不使用則改為'')
$backpicture                = '';                                       #背景圖檔
$bgcolor                    = 'white';                                  #背景顏色
...
$e_font                     = "Verdana, Arial";                 #英文專屬字形集                     (驚直加入)
...
$homelinklogo               = '<img src=./img/kakikomitai_linkhome.gif width=50 height=12 border=0 alt=個人網站>';	#留言者個人網站連結圖檔IMG語法 (不使用則改為'')
$maillinklogo               = '<img src=./img/kakikomitai_linkmail.gif width=50 height=12 border=0 alt=電子郵箱>';	#留言者電子郵箱連結圖檔IMG語法 (不使用則改為'')

$top_l                      = '<img src=./img/top_l_h.gif width=8 height=8>';       #造成留言框圓角效果的圖檔IMG語法 (左上角) (不使用則改為'')
$top_r                      = '<img src=./img/top_r_h.gif width=8 height=8>';       #造成留言框圓角效果的圖檔IMG語法 (右上角) (不使用則改為'')
$bottom_l                   = '<img src=./img/bottom_l_h.gif width=8 height=8>';    #造成留言框圓角效果的圖檔IMG語法 (左下角) (不使用則改為'')
$bottom_r                   = '<img src=./img/bottom_r_h.gif width=8 height=8>';    #造成留言框圓角效果的圖檔IMG語法 (右下角) (不使用則改為'')
...
$gif_email          = './img/kakikomitai_email.gif';    #(電子郵箱)
...
$oicon_gif    = './icon/d_ahiru.gif' ;      $oiconpass = 'opass';           $oicon_gif_w = 32 ; $oicon_gif_h = 32 ;
...
$jicon_gif[0] = './icon/kuma.gif' ;         $jiconnm[0] = 'Ａ君' ;          $jicon_gif_w[0] = 50 ; $jicon_gif_h[0] = 50 ;
$jicon_gif[1] = './icon/parappa.gif' ;      $jiconnm[1] = 'Ｂ君' ;          $jicon_gif_w[1] = 50 ; $jicon_gif_h[1] = 50 ;

#↓設定留言者一般可選擇之圖檔。可以依個人需要增加其他圖檔如$icon_gif[11]...[20]等，餘此類推。
$icon_gif[0]  = './icon/1.png' ;         $iconnm[0]  = '皮球' ;          $icon_gif_w[0]  = 50 ; $icon_gif_h[0]  = 50 ;
$icon_gif[1]  = './icon/corgi.gif' ;        $iconnm[1]  = '小狗' ;          $icon_gif_w[1]  = 50 ; $icon_gif_h[1]  = 50 ;
$icon_gif[2]  = './icon/cow.gif' ;          $iconnm[2]  = '乳牛' ;          $icon_gif_w[2]  = 50 ; $icon_gif_h[2]  = 50 ;
$icon_gif[3]  = './icon/denchi.gif' ;       $iconnm[3]  = '電池' ;          $icon_gif_w[3]  = 50 ; $icon_gif_h[3]  = 50 ;
$icon_gif[4]  = './icon/dorayaki.gif' ;     $iconnm[4]  = '燒餅' ;          $icon_gif_w[4]  = 50 ; $icon_gif_h[4]  = 50 ;
$icon_gif[5]  = './icon/duck.gif' ;         $iconnm[5]  = '鴨子' ;          $icon_gif_w[5]  = 50 ; $icon_gif_h[5]  = 50 ;
$icon_gif[6]  = './icon/h_bambi.gif' ;      $iconnm[6]  = '松鼠' ;          $icon_gif_w[6]  = 50 ; $icon_gif_h[6]  = 50 ;
$icon_gif[7]  = './icon/h_bear.gif' ;       $iconnm[7]  = '米熊' ;          $icon_gif_w[7]  = 50 ; $icon_gif_h[7]  = 50 ;
$icon_gif[8]  = './icon/h_kaeru.gif' ;      $iconnm[8]  = '青蛙' ;          $icon_gif_w[8]  = 50 ; $icon_gif_h[8]  = 50 ;
$icon_gif[9]  = './icon/h_momo.gif' ;       $iconnm[9]  = 'momo' ;          $icon_gif_w[9]  = 50 ; $icon_gif_h[9]  = 50 ;
$icon_gif[10] = './icon/h_saru.gif' ;       $iconnm[10] = '猴子' ;          $icon_gif_w[10] = 50 ; $icon_gif_h[10] = 50 ;
...
sub forminput {
    ...
    if ( $icon_rank == 0 && $icon_use eq 'yes') {
        ...
        print "</select>\n";
		print "&nbsp;&nbsp;<span style=font-size:$pt_mini>[ <a href=\"$script?action=icondisp\" target=_blank>圖檔一覽表</a> ]</span>\n";	#(驚直修改 - 改以新視窗方式開啟,以微縮字形大小顯示)
        #留言密碼
        print "&nbsp;&nbsp;&nbsp;&nbsp;留言密碼：\n";
        print "<input type=password name=\"pass\" size=8 value=\"$c_pass\" $css_style>&nbsp;&nbsp;(修改及刪除留言時用)</td>\n";
        print "</tr></table>";
...
sub header2 {
    ...
    if ( $#oldcnt >= 0 ) {
        ...
        foreach ( @oldcnt ) {
            ...
            print "<option value=$i $dmy >舊留言集＃$i";
            $i++ ;
        }
        print "</select>\n";
...
sub view    {
    ...
    print "<br>下載時，請把檔案的延伸檔名改為 <font face=\"$e_font\">htm / html</font>。";
    print "</form></center>\n";
    if ( $FORM{'oldlogno'} == 0 )   {
        print "<hr width=70% size=1 noshade color=black>\n";
...
###<--------------------------------------------------------------
sub download {
    print "Content-type: text/download; charset=big5\n\n";  #(驚直修改 - 加入繁體中文語系標籤)
    print "<html><head>\n";
    print "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=big5\">\n";   #(驚直修改 - 加入繁體中文語系識別語法)
